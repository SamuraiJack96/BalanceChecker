// src/lib.rs
/*
 * Core library for BalanceChecker
 */
...
#[derive(Debug)]
pub struct BalanceCheckerProcessor {
    verbose: bool,
    processed_count: usize,
}

impl BalanceCheckerProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting BalanceChecker processing");
    
    let mut processor = BalanceCheckerProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = BalanceCheckerProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = BalanceCheckerProcessor::new(false);
